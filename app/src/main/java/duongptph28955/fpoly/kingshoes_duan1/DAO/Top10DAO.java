...
public class Top10DAO {
    ...
    public ArrayList<SanPham> getTop10(){
        ...
        Cursor cursor = sqLiteDatabase.rawQuery("SELECT hd.maSanPham, sp.tenSanPham, COUNT(hd.maSanPham), sp.hinhAnh FROM HOADON hd, SANPHAM sp WHERE hd.maSanPham = sp.maSanPham GROUP by hd.maSanPham, sp.tenSanPham ORDER BY COUNT(hd.maSanPham) DESC LIMIT 10", null);
